...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('faq_qestions_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('question', models.ForeignKey(orm['faq.question'], null=False)),
            ('category', models.ForeignKey(orm['faq.category'], null=False))
        ))
        db.create_unique('faq_qestions_categories', ['question_id', 'category_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('faq_qestions_categories')
    ...
    models = {
        ...
        'faq.category': {
            'Meta': {'ordering': "('title',)", 'object_name': 'Category', 'db_table': "'faq_categories'"},
        ...
        'faq.question': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['faq.Category']", 'null': 'True', 'blank': 'True'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
